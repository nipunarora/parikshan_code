...
//static char* pass = "multifacet"; ///< default password
static char* pass = ""; ///< no password
static char* database = "test"; ///< default database
//static const char* mysqlpath = "/scratch/mysql/bin/mysqladmin"; ///< path to mysql
//static const char* mysqlpath = "/home/mysql-4.1.1-alpha/mysql/bin";
static const char* mysqlpath = "/mnt/exodus/violas/shanbin/debug/mysql4_debug/bin";
static const char* sarpath = "/bin/sar"; ///< path to sar
static const char* sshpath = "/s/std/bin/ssh"; ///< path to ssh
...
static void* start_new(void* resultparam) {
     ...
     if (!mysql_real_connect(&dbase, host, user, pass, database, 0, "/tmp/mysql.sock", 0)) {
     //if (!mysql_real_connect(&dbase, host, user, pass, database, 0, "/home/mysql-4.1.1-alpha/mysql.sock", 0)) {
