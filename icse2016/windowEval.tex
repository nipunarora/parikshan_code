...
We observed, that compared to earlier experiments, there was more slack in the system with slightly lesser amount of requests, this meant that our system was able to tolerate a much higher overhead (3.2x) with no buffer overflows.
