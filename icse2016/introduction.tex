...
\item \textbf{Short time-to-debug:} These techniques contribute to a shortened debug time, by allowing system debuggers to directly gather trace data rather then wait for operators. 
