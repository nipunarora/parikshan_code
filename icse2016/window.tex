...
However, as the instrumentation overhead increases, the incoming rate of requests may eventually exceed the transaction processing rate.
...
In such cases, for a server receiving a heavy workload, the amount of calls in a single session may eventually have a cumulative effect and cause overflows.
