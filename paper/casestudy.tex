...
\begin{table*}[ht!]
	...
	\begin{tabular}{|l|l|l|l|l|l|l|}
		\hline
		Bug-Name             & Bug-Type          & Explanation & Type & Nodes & Trigger & Software     \\ \hline
		Redis Bug \#487      & Semantic Bug      & ~           & ~                                 & ~           & ~                              & Redis        \\
		Cassandra Bug \#5225 & Semantic Bug      & ~           & ~                                 & ~           & ~                              & Cassandra    \\
		Cassandra Bug \#1837 & Semantic Bug      & ~           & ~                                 & ~           & ~                              & Cassandra    \\
		Redis Bug \#614     & Resource Leak     & ~           & ~                                 & ~           & ~                              & Redis        \\
		Redis Bug \#417      & Resource Leak     & ~           & ~                                 & ~           & ~                              & Redis        \\
		Redis Bug \#957     & Configuration Bug & ~           & ~                                 & ~           & ~                              & Redis        \\
		mysql  Bug \#49491   & Performance Bug   & ~           & ~                                 & ~           & ~                              & MySQL \\
		mysql Bug \#15811    & Performance Bug   & ~           & ~                                 & ~           & ~                              & MySQL \\
		Redis Bug \#761      & Crash Bug         & ~           & ~                                 & ~           & ~                              & Redis        \\
		HBASE Bug \#9115     & Semantic Bug      & ~           & ~                                 & ~           & ~                              & HBase        \\
		Apache Bug \#25520   & Concurrency Bug   & ~           & Non Deterministic                 & ~           & ~                              & Apache       \\
		Apache Bug \#21287   & Concurrency Bug   & ~           & Non Deterministic                 & ~           & ~                              & Apache       \\
		Mysql Bug \#791      & Concurrency Bug   & ~           & Non Deterministic                 & ~           & ~                              & MySQL \\
		Mysql Bug \#644      & Concurrency Bug   & ~           & Non Deterministic                 & ~           & ~                              & MySQL \\
		MySql Bug \#169      & Concurrency Bug   & ~           & Non Deterministic                 & ~           & ~                              & MySQL \\ \hline
