...
A customized-network proxy agent replicates inputs from clients to both the production and test-container, as well as safely discard all outputs from the test-container.
