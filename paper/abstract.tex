...
Modern 24x7 systems rely on fast bug resolution to mantain their services. Hence, time-to-bug localization, is an extremely important metric for service oriented applications.
...
This \textit{debug-container} provides a sandbox environment for debugging without any perturbation to the execution environment. 
