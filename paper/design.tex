...
%\parikshan can be applied at the boundary of every tier of a multi-tier system. In figure \ref{fig:workflow} we show parikshan being applied to a single tier boundary( communication from a webserver to a backend server) to showcase a simple example, this process can be easily scaled depending on the complexity of the system design. 
