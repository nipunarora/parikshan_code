...
The motivation behind our work is to provide testing as a service for real-time diagnosis of production applications, in order to signifcantly reduce the time towards bug resolution.
