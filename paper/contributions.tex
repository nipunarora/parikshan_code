...
Software patches for performance or functional updates are frequently done on back-end servers. 
These may not necessarily change the user-facing input and can be optimization internal in the back-end server.
