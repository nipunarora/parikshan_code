...
We present \livedebugging, a mechanism which allows debugging of production systems (run test-cases, debug, or profile, etc.) on-the-fly. 
...
We used our system, called \texttt{Parikshan}, to do \livedebugging on several real-world bugs, and effectively reduced debugging complexity and time.
