# 
# 
# Filename: python_multithreaded_server.py
# Author: Nipun Arora
# Created: Fri Jul  4 18:56:32 2014 (-0400)
...
def main(config, errorlog):
    ...
    """ basically single threaded just for the sake of troubleshooting"""
...
def duplicate(dock_socket,client_socket):
...
def server(*settings):
    try:
        ...
        print "Starting Server on the following settings: %s, %s, %s, %s\n" % (settings[0],settings[1],settings[2],settings[3])
        ...
        while True:
            ...
            thread.start_new_thread(duplicate,(dock_socket,client_socket))
